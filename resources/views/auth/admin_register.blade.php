                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            <div class="bg-login text-center">
                                ...
                                <div class="position-relative">
                                    ...
                                    <p class="text-white-50 mb-0">Get your NowOrder account now</p>
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div class="p-2">
                                    <form method="POST" action="{{ route('register.store') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="category">{{ __('Business Category') }}</label>
                                            <select class="form-control @error('category') is-invalid @enderror"
                                                ...
                                                @if(isset($businesscategories))
                                                    @foreach($businesscategories as $list)
                                                        <option value="{{$list->id}}" {{old('category') == $list->id ?'selected':''}}>{{$list->name}}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-primary btn-block waves-effect waves-light"
                                                    id="register" type="submit"> {{ __('Register') }}</button>
                                        </div>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <p>©
                                ...
                                NowOrder. Crafted with <i class="mdi mdi-heart text-danger"></i> by Zero Technology
                            </p>
                        </div>
