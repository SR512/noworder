            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="text-white-50 mb-0">Sign in to continue to NowOrder.</p>
                    ...
                    <div class="mt-5 text-center">
                        <p>Don't have an account ? <a href="{{route('register.create')}}" class="font-weight-medium text-primary"> Signup now </a> </p>
                        <p>© <script>
                                document.write(new Date().getFullYear())
                            </script> NowOrder. Crafted with <i class="mdi mdi-heart text-danger"></i>by Zero Technology</p>
                    </div>
