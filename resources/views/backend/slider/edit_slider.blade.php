                    ...
                    <form method="POST" action="{{ route('sliders.update',$slider->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ $slider->name }}"
                                           autocomplete="name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <img src="{{asset('asset2/Slider/' . $slider->backgroundphoto)}}"
                                         class="img-thumbnail rounded" width="300px">';
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <button class="btn btn-primary btn-sm waves-effect waves-light" id="register"
                                    type="submit"> {{ __('Update Slider') }}</button>
                        </div>
