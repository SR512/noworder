...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') Store Detail  @endslot
        ...
        <div class="col-md-12 col-xl-3">
                    ...
                    <div class="profile-widgets py-3">
                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-3 ">
                                ...
                                <p class="text-body mt-1 mb-1">{{$user->businessname}}</p>
                            </div>
                            @if($user->payment_verified_at != null)
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="font-size-12 text-muted mb-1">City</p>
                        <h6 class="">{{$user->city}}</h6>
                    </div>

                    <div class="mt-3">
                        <p class="font-size-12 text-muted mb-1">State</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#revenue" role="tab">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#settings" role="tab">
                                ...
                                <span class="d-none d-sm-block">Website Settings</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="revenue" role="tabpanel">
                            <form method="POST" action="{{ route('users.update.detail') }}">
                                @csrf

                                <input type="hidden" class="form-control" id="id" name="id" value="{{$user->id}}">
                                <input type="hidden" class="form-control" name="hiddencity" value="{{$user->city}}">
                                <input type="hidden" class="form-control" name="hiddenstate" value="{{$user->state}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="businessname"
                                                   ...
                                                   value="{{ $user->businessname }}" id="businessname"
                                                   placeholder="Enter Business Name" autocomplete="businessname">
                                            @error('businessname')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="mobile"
                                                   ...
                                                   id="mobile"
                                                   placeholder="Enter Mobile Number" autocomplete="mobile">
                                            @error('mobile')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email"
                                                   ...
                                                   name="email" value="{{ $user->email }}" id="useremail"
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="firstname">Payment Key</label>
                                            <input type="text" class="form-control" id="key" name="razor_key"
                                                   placeholder="API KEY" value="{{$user->razor_key}}">
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="firstname">Payment Secret</label>
                                            <input type="text" class="form-control" id="secret" name="razor_secret"
                                                   placeholder="API Secret" value="{{$user->razor_secret}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">

                                        <div class="form-group">
                                            <label for="time">{{ __('Open Time') }}</label>
                                            <textarea name="time"
                                                      class="form-control @error('time') is-invalid @enderror"
                                                      autofocus
                                                      id="time"
                                                      placeholder="Enter Time">{{ $user->time }}</textarea>
                                            @error('time')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="gst" name="gst"
                                                   placeholder="Enter GST" value="{{$user->gst}}">
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <h5 class="font-size-14 mb-4">GST SHOW BILL</h5>
                                    <div class="form-group">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="radio" name="isgst"
                                                   id="exampleRadios1"
                                                   value="yes" {{$user->isgst != 0? 'checked':''}}>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <h5 class="font-size-14 mb-4">Store Open</h5>
                                        <div class="form-group">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="isopen"
                                                       id="exampleRadios1"
                                                       value="yes" {{$user->isopen != 0? 'checked':''}}>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Yes
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="isopen"
                                                       id="exampleRadios2"
                                                       value="no" {{$user->isopen == 0 ?'checked':''}}>
                                                <label class="form-check-label" for="exampleRadios2">
                                                    No
                                                </label>
                                            </div>
                    ...
                    <div class="tab-pane" id="settings" role="tabpanel">
                        <form method="POST" action="{{ route('users.update.websettings') }}">
                            @csrf
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div>
                                        <h5 class="font-size-14 mb-4">Cash On Delivery</h5>
                                        <div class="form-group">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="iscod"
                                                       id="exampleRadios1"
                                                       value="yes" {{$user->iscod == 1 ? 'checked':''}}>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Yes
                                                </label>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        <h5 class="font-size-14 mb-4">Payemt Gatway</h5>
                                        <div class="form-group">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="ispayment"
                                                       id="exampleRadios1"
                                                       value="yes" {{$user->ispayment == 1?'checked':''}}>
                                                <label class="form-check-label" for="exampleRadios1">
                                                    Yes
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="ispayment"
                                                       id="exampleRadios2"
                                                       value="no" {{$user->ispayment == 0 ?'checked':''}}>
                                                <label class="form-check-label" for="exampleRadios2">
                                                    No
                                                </label>
                                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fb" value="{{ $user->fb }}"
                                               autocomplete="fb"
                                               class="form-control @error('fb') is-invalid @enderror" autofocus
                                               id="fb" placeholder="Enter Your FB Page / Account Link ">
                                        @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="insta">{{ __('Instagram') }}</label>
                                        <input type="text" name="insta"
                                               class="form-control @error('insta') is-invalid @enderror"
                                               value="{{ $user->insta }}" id="insta"
                                               placeholder="Enter Instagram Link" autocomplete="insta">
                                        @error('insta')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="youtube" value="{{ $user->youtube }}"
                                               ...
                                               class="form-control @error('youtube') is-invalid @enderror" autofocus
                                               id="youtube" placeholder="Enter Your Youtube Channel / Video Link ">
                                        @error('youtube')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="whatsapp"
                                               ...
                                               value="{{ $user->whatsapp }}" id="whatsapp"
                                               placeholder="Enter Whatsapp Link" autocomplete="whatsapp">
                                        @error('whatsapp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        option_str.length = 0;
        option_str.options[0] = new Option('Select State', '0');
        ...
        function print_city(city_id, city_index) {
            ...
            option_str.options[0] = new Option('Select City', '0');
            option_str.selectedIndex = 0;
