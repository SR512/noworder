...
@section('title') Store Item Attribute @endsection
@section('css')
...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') Store Item Attribute  @endslot
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('attributevalues.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                                    ...
                                    <select  class="form-control @error('attribute') is-invalid @enderror" name="attribute">
                                        ...
                                        @if(isset($attributes))
                                            @foreach($attributes as $list)
                                                <option value="{{$list->id}}">{{$list->attribute}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('category')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="value" value="{{ old('name') }}"
                                           autocomplete="value"
                        ...
                        <div class="mt-4">
                            <button class="btn btn-primary btn-sm waves-effect waves-light" id="register"
                                    type="submit"> {{ __('Add Attribute') }}</button>
                        </div>
                    </form>
