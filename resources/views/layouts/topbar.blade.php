            ...
            <div class="float-right">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
                        <a class="dropdown-item" href="{{route('users.detail',auth()->guard('admin')->user()->id)}}"><i class="bx bx-user font-size-16 align-middle mr-1"></i> Profile</a>
            ...
            <div>
                ...
                <div class="navbar-brand-box">
                    <a href="index" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{asset('images/logo-sm.png')}}" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <a href="index" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="{{asset('images/logo-sm.png')}}" alt="" height="19">
